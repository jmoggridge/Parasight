...
#Plot decision tree
fancyRpartPlot(model=rpartTree2, main="2-mer decision tree of Apicomplexa", caption = "Genus classification")
```
...
#Plot decision tree
fancyRpartPlot(model=rpartTree3, main="3-mer decision tree of Apicomplexa", caption = "Genus classification")
```
**Figure 6**. 3-mer decision tree of Apicomplexan genera.
```{r 4-mer Classification}
#Predict test dataset
rpartPredict4 <- predict(rpartTree, newdata = genusTrain[,85-340], type='class')
...
#Plot decision tree
fancyRpartPlot(model=rpartTree, main="4-mer decision tree of Apicomplexa", caption = "Genus classification")
```
